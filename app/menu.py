...
class User(Salarie):
    ...
    def __init__(self, nom, prenom, ville, role, login=None, password_hash=None, password_expiry=None, account_locked_until=None):
        ...
        # Les champs password_expiry et account_locked_until existent en base
        # mais ne sont pas stockés ici directement (optionnel selon tes besoins)
    ...
    def changer_mot_de_passe(self, ancien_mot_de_passe, nouveau_mot_de_passe):
        ...
        # Vérification de taille (peut être renforcée si besoin)
